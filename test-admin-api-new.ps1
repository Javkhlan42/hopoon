...
Write-Host ""
Write-Host "=== Step 2: Get Users ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Step 3: Get Rides ===" -ForegroundColor Cyan
...
# 4. Ride Statistics
Write-Host ""
Write-Host "=== Step 4: Ride Statistics ===" -ForegroundColor Cyan
...
# 5. Top Drivers
Write-Host ""
Write-Host "=== Step 5: Top Drivers ===" -ForegroundColor Cyan
...
Write-Host "Admin API endpoints tested" -ForegroundColor Green
Write-Host ""
